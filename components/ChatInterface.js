System.register(["react/jsx-runtime", "react-native", "tamagui", "react", "jotai", "../lib/state/atoms", "../lib/agents/human-design-agent", "ai", "../lib/ai/client"], function (exports_1, context_1) {
    "use strict";
    var jsx_runtime_1, react_native_1, tamagui_1, react_1, jotai_1, atoms_1, human_design_agent_1, ai_1, client_1, styles;
    var __moduleName = context_1 && context_1.id;
    function ChatInterface() {
        const [messages, setMessages] = jotai_1.useAtom(atoms_1.messagesAtom);
        const [birthData] = jotai_1.useAtom(atoms_1.birthDataAtom);
        ...
        const sendMessage = async () => {
            ...
            try {
                ...
                console.log('[ChatInterface] Using model:', client_1.chatModel);
                ...
                if (query.toLowerCase().includes('design') ||
                    ...
                    const hdAgent = new human_design_agent_1.HumanDesignAgent();
        ...
        return (_jsxs(react_native_1.KeyboardAvoidingView, { style: styles.container, behavior: react_native_1.Platform.OS === 'ios' ? 'padding' : 'height', keyboardVerticalOffset: 100, children: [_jsx(react_native_1.FlatList, { data: messages, keyExtractor: (item) => item.id, renderItem: ({ item }) => (_jsxs(react_native_1.View, { style: [
                            styles.messageBubble,
                            item.role === 'user' ? styles.userBubble : styles.assistantBubble,
                        ], children: [_jsx(tamagui_1.Text, { style: item.role === 'user' ? styles.userText : styles.assistantText, children: item.content || '...' }), item.agentData && (_jsxs(tamagui_1.Text, { style: styles.metaText, children: [item.agentData.method, " \u2022 ", item.agentData.confidence ? `${(item.agentData.confidence * 100).toFixed(0)}% confidence` : ''] }))] })), style: styles.messageList, contentContainerStyle: styles.messageListContent }), isLoading && (_jsx(react_native_1.View, { style: styles.loadingContainer, children: _jsx(tamagui_1.Text, { children: "Generating response..." }) })), _jsxs(react_native_1.View, { style: styles.inputContainer, children: [_jsx(react_native_1.TextInput, { style: styles.input, value: input, onChangeText: setInput, placeholder: "Ask about your Human Design...", placeholderTextColor: "#999", onSubmitEditing: sendMessage, editable: !isLoading, multiline: true }), _jsx(react_native_1.TouchableOpacity, { style: [styles.sendButton, (!input.trim() || isLoading) && styles.sendButtonDisabled], onPress: sendMessage, disabled: !input.trim() || isLoading, children: _jsx(tamagui_1.Text, { style: styles.sendButtonText, children: "Send" }) })] })] }));
    }
    exports_1("ChatInterface", ChatInterface);
    return {
        setters: [
            ...
            function (human_design_agent_1_1) {
                human_design_agent_1 = human_design_agent_1_1;
            },
            function (ai_1_1) {
                ai_1 = ai_1_1;
            },
