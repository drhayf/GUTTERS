# Contributing to GUTTERS

Thank you for your interest in contributing to GUTTERS! This guide is meant to make it easy for you to get started.
...
Start by forking and cloning the GUTTERS repository:

1. **Fork the Repository**: Begin by forking the project repository on GitHub.
...
GUTTERS uses uv for managing dependencies. If you don't have uv installed, follow the instructions on the [official uv website](https://docs.astral.sh/uv/).
...
GUTTERS uses pytest for testing. Run tests using:
...
Thank you for contributing to GUTTERS 🚀
