...
class ChronosStateManager:
    ...
    async def get_current_hexagram(self, user_id: int | None = None) -> dict[str, Any] | None:
        ...
        try:
            from ...modules.intelligence.iching import GATE_DATABASE, IChingKernel
    ...
    async def get_council_synthesis(self, user_id: int | None = None) -> dict[str, Any] | None:
        ...
        try:
            ...
            synthesis_dict = {
                ...
                "resonance_type": (
                    synthesis.resonance_type.value
                    if hasattr(synthesis.resonance_type, 'value')
                    else str(synthesis.resonance_type)
                ),
