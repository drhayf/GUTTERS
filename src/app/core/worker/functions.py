...
async def update_solar_tracking_job(ctx: Worker) -> None:
    ...
    from app.modules.tracking.solar.tracker import SolarTracker
    from app.core.db.database import async_session
...
async def update_lunar_tracking_job(ctx: Worker) -> None:
    ...
    from app.modules.tracking.lunar.tracker import LunarTracker
    from app.core.db.database import async_session
    from sqlalchemy import select
    from app.models.user import User
    import traceback
...
async def update_transit_tracking_job(ctx: Worker) -> None:
    ...
    from app.modules.tracking.transits.tracker import TransitTracker
    from app.core.db.database import async_session
    from sqlalchemy import select
    from app.models.user import User
    import traceback
                ...
                try:
                    ...
                    for entry in journal_entries:
                        ...
                        exists_stmt = select(Embedding).where(
                            ...
                            Embedding.content_metadata['entry_id'].astext == str(entry_id)
                        )
