...
**{chart.type}s** are designed to {chart.strategy.lower()}. This isn't a personality
trait - it's about how your energy field naturally operates.
...
**What this means:** The Type is a strong indicator, but for the complete picture
- including how you make decisions and what your life purpose is - we'd need your birth time.

If you can find your birth time (check birth certificate, hospital records, or ask
family), I can generate your complete chart.

For now: As a {chart.type}, notice how your energy responds to opportunities.
{chart.strategy} might feel counterintuitive to conditioning, but it's your natural rhythm."""
...
Keep it conversational (800-1200 words). Use "you might notice..." framing. Balance
gifts with challenges. Be specific to THIS chart."""
