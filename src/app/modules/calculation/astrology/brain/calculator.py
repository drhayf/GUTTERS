...
def calculate_natal_chart(
    ...
    if is_solar_chart:
        ...
        rising_data = _calculate_probabilistic_rising(
...
def _calculate_probabilistic_rising(
    birth_date: date,
    latitude: float,
    longitude: float,
    timezone: str
    ...
    for sign, count in rising_counts.most_common():
        ...
        confidence = "certain" if probability >= 1.0 else \
    ...
    return {
        ...
        "most_likely_ascendant": {
            "sign": most_likely_sign,
            "degree": 15.0
        },
