...
You're a wise interpreter, not a fortune teller."""
    ...
    NUMBER_MEANINGS = {
        1: {
            ...
            "gifts": "Pioneer, innovative, self-starter",
            "challenges": "Ego, isolation, stubbornness",
        },
        2: {
            "theme": "Partnership & Harmony",
            "gifts": "Diplomatic, intuitive, supportive",
            "challenges": "Over-sensitivity, indecision, dependency",
        },
        3: {
            "theme": "Expression & Creativity",
            "gifts": "Artistic, communicative, joyful",
            "challenges": "Scattered, superficial, moody",
        },
        4: {
            "theme": "Foundation & Structure",
            "gifts": "Practical, reliable, disciplined",
            "challenges": "Rigid, workaholic, resistant to change",
        },
        5: {
            "theme": "Freedom & Adventure",
            "gifts": "Versatile, adaptable, curious",
            "challenges": "Restless, impulsive, scattered",
        },
        6: {
            "theme": "Nurturing & Responsibility",
            "gifts": "Caring, harmonious, artistic",
            "challenges": "Self-sacrificing, controlling, perfectionist",
        },
        7: {
            "theme": "Wisdom & Introspection",
            "gifts": "Analytical, spiritual, truth-seeking",
            "challenges": "Isolated, secretive, overly critical",
        },
        8: {
            "theme": "Power & Abundance",
            "gifts": "Ambitious, executive, material mastery",
            "challenges": "Workaholic, materialistic, controlling",
        },
        9: {
            "theme": "Humanitarianism & Completion",
            "gifts": "Compassionate, wise, universal love",
            "challenges": "Detached, scattered, martyr complex",
        },
        11: {
            "theme": "Master Intuition",
            "gifts": "Visionary, inspirational, highly intuitive",
            "challenges": "Nervous energy, impractical, overwhelmed",
        },
        22: {
            "theme": "Master Builder",
            "gifts": "Manifests big dreams, practical visionary",
            "challenges": "Overwhelmed by potential, self-doubt",
        },
        33: {
            "theme": "Master Teacher",
            "gifts": "Healer, uplifter, selfless service",
    ...
    def _interpret_basic(self, chart) -> str:
        ...
        if chart.master_numbers:
            master_note = (
                ...
                f"- You carry heightened potential and responsibility."
            )

        karmic_note = ""
        if chart.karmic_debt_numbers:
            karmic_note = (
                f"\n\n**Karmic Lessons:** {', '.join(map(str, chart.karmic_debt_numbers))} "
                f"- Areas for growth and integration."
            )
    ...
    async def _interpret_full(self, chart, user_query: Optional[str]) -> str:
        ...
        if chart.karmic_debt_numbers:
            special_notes.append(
                f"Karmic Debt: {', '.join(map(str, chart.karmic_debt_numbers))} "
