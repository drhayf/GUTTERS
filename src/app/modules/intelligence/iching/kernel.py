...
GATE_DATABASE: Dict[int, GateData] = {
    ...
    1: GateData(
        ...
        iching_image="The movement of heaven is full of power. Thus the superior man makes himself strong and untiring.",
        ...
        lines={
            1: LineInterpretation(
                ...
                description="Creative potential exists but timing isn't right. Preparation phase. The foundation is being built.",
                exaltation="Saturn",
                detriment="Jupiter"
            ),
            ...
            3: LineInterpretation(
                ...
                description="Sustained creative effort. Tireless innovation. Risk of burnout but necessary for breakthrough.",
                exaltation="Mars",
                detriment="Saturn"
            ),
            4: LineInterpretation(
                ...
                description="Testing your wings. Creative uncertainty. Exploring possibilities without full commitment.",
                exaltation="Venus",
                detriment="Mars"
            ),
    ...
    2: GateData(
        ...
        iching_chinese="坤",
        iching_pinyin="Kūn",
        iching_judgment="The Receptive brings about sublime success, furthering through the perseverance of a mare.",
        iching_image="The earth's condition is receptive devotion. Thus the superior man who has breadth of character carries the outer world.",
    ...
    5: GateData(
        ...
        iching_chinese="需",
        iching_pinyin="Xū",
        iching_judgment="Waiting. If you are sincere, you have light and success. Perseverance brings good fortune.",
        iching_image="Clouds rise up to heaven: the image of waiting. Thus the superior man eats and drinks, is joyous and of good cheer.",
    ...
    8: GateData(
        ...
        iching_chinese="比",
        iching_pinyin="Bǐ",
        iching_judgment="Holding together brings good fortune. Inquire of the oracle once again whether you possess sublimity, constancy, and perseverance.",
    ...
    13: GateData(
        ...
        lines={
            1: LineInterpretation(
                ...
                description="Open and honest communication. Building community from the foundation. Welcoming all without prejudice.",
                exaltation="Neptune",
                detriment="Mercury"
            ),
            2: LineInterpretation(
            ...
            5: LineInterpretation(
                ...
                description="Mediator energy. Bringing opposing sides together. Joy follows the hard work of reconciliation.",
                exaltation="Venus",
                detriment="Saturn"
            ),
            6: LineInterpretation(
    ...
    19: GateData(
        ...
        iching_chinese="臨",
        iching_pinyin="Lín",
        iching_judgment="Approach has supreme success. Perseverance furthers. When the eighth month comes, there will be misfortune.",
    ...
    27: GateData(
        ...
        iching_chinese="頤",
        iching_pinyin="Yí",
        iching_judgment="The corners of the mouth. Perseverance brings good fortune. Pay heed to the providing of nourishment and to what a man seeks to fill his own mouth with.",
        iching_image="At the foot of the mountain, thunder: the image of providing nourishment.",
    ...
    28: GateData(
        ...
        iching_judgment="Preponderance of the great. The ridgepole sags to the breaking point. It furthers one to have somewhere to go.",
    ...
    29: GateData(
        ...
        iching_chinese="坎",
        iching_pinyin="Kǎn",
        iching_judgment="The abysmal repeated. If you are sincere, you have success in your heart, and whatever you do succeeds.",
    ...
    35: GateData(
        ...
        iching_chinese="晉",
        iching_pinyin="Jìn",
        iching_judgment="Progress. The powerful prince is honored with horses in large numbers. In a single day he is granted audience three times.",
    ...
    39: GateData(
        ...
        iching_chinese="蹇",
        iching_pinyin="Jiǎn",
        iching_judgment="Obstruction. The southwest furthers. The northeast does not further. It furthers one to see the great man. Perseverance brings good fortune.",
    ...
    40: GateData(
        ...
        iching_chinese="解",
        iching_pinyin="Xiè",
        iching_judgment="Deliverance. The southwest furthers. If there is no longer anything where one has to go, return brings good fortune.",
    ...
    45: GateData(
        ...
        iching_chinese="萃",
        iching_pinyin="Cuì",
        iching_judgment="Gathering together. Success. The king approaches his temple. It furthers one to see the great man. This brings success. Perseverance furthers.",
    ...
    47: GateData(
        ...
        iching_chinese="困",
        iching_pinyin="Kùn",
        iching_judgment="Oppression. Success. Perseverance. The great man brings about good fortune. No blame. When one has something to say, it is not believed.",
    ...
    48: GateData(
        ...
        iching_chinese="井",
        iching_pinyin="Jǐng",
        iching_judgment="The well. The town may be changed, but the well cannot be changed. It neither decreases nor increases.",
    ...
    49: GateData(
        ...
        iching_chinese="革",
        iching_pinyin="Gé",
        iching_judgment="Revolution. On your own day you are believed. Supreme success, furthering through perseverance. Remorse disappears.",
    ...
    51: GateData(
        ...
        iching_chinese="震",
        iching_pinyin="Zhèn",
        iching_judgment="Shock brings success. Shock comes—oh, oh! Laughing words—ha, ha! The shock terrifies for a hundred miles, and he does not let fall the sacrificial spoon and chalice.",
    ...
    52: GateData(
        ...
        iching_chinese="艮",
        iching_pinyin="Gèn",
        iching_judgment="Keeping still. Keeping his back still so that he no longer feels his body. He goes into his courtyard and does not see his people. No blame.",
    ...
    57: GateData(
        ...
        iching_chinese="巽",
        iching_pinyin="Xùn",
        iching_judgment="The gentle. Success through what is small. It furthers one to have somewhere to go. It furthers one to see the great man.",
    ...
    59: GateData(
        ...
        iching_chinese="渙",
        iching_pinyin="Huàn",
        iching_judgment="Dispersion. Success. The king approaches his temple. It furthers one to cross the great water. Perseverance furthers.",
    ...
    61: GateData(
        ...
        iching_judgment="Inner truth. Pigs and fishes. Good fortune. It furthers one to cross the great water. Perseverance furthers.",
    ...
    62: GateData(
        ...
        iching_judgment="Preponderance of the small. Success. Perseverance furthers. Small things may be done; great things should not be done.",
    ...
    63: GateData(
        ...
        iching_chinese="既濟",
        iching_pinyin="Jì Jì",
        iching_judgment="After completion. Success in small matters. Perseverance furthers. At the beginning good fortune, at the end disorder.",
    ...
    64: GateData(
        ...
        iching_judgment="Before completion. Success. But if the little fox, after nearly completing the crossing, gets his tail in the water, there is nothing that would further.",
...
CHANNELS: Dict[tuple, ChannelData] = {
    ...
    (64, 47): ChannelData(64, 47, Center.HEAD, Center.AJNA, "Abstraction", "Collective", "Mental activity, doubt, confusion"),
    ...
    # Throat -> Sacral
    (20, 34): ChannelData(20, 34, Center.THROAT, Center.SACRAL, "Charisma", "Individual", "Where thoughts become actions"),
    
    # Throat -> G Center
    (20, 10): ChannelData(20, 10, Center.THROAT, Center.G, "Awakening", "Individual", "Commitment to higher principles"),
    ...
    # Throat -> Solar Plexus
    (35, 36): ChannelData(35, 36, Center.THROAT, Center.SOLAR_PLEXUS, "Transitoriness", "Collective", "A jack of all trades"),
...
INCARNATION_CROSSES: Dict[int, Dict[str, str]] = {
    1: {"RAC": "Right Angle Cross of the Sphinx 4", "JXP": "Juxtaposition Cross of Self-Expression", "LAC": "Left Angle Cross of Defiance 2"},
    2: {"RAC": "Right Angle Cross of the Sphinx 2", "JXP": "Juxtaposition Cross of the Driver", "LAC": "Left Angle Cross of Defiance 1"},
    3: {"RAC": "Right Angle Cross of Laws 1", "JXP": "Juxtaposition Cross of Mutation", "LAC": "Left Angle Cross of Wishes 1"},
    4: {"RAC": "Right Angle Cross of Explanation 2", "JXP": "Juxtaposition Cross of Formulization", "LAC": "Left Angle Cross of Revolution 2"},
    5: {"RAC": "Right Angle Cross of Consciousness 1", "JXP": "Juxtaposition Cross of Habits", "LAC": "Left Angle Cross of Separation 1"},
    6: {"RAC": "Right Angle Cross of Eden 1", "JXP": "Juxtaposition Cross of Conflict", "LAC": "Left Angle Cross of the Plane 1"},
    7: {"RAC": "Right Angle Cross of the Sphinx 3", "JXP": "Juxtaposition Cross of Interaction", "LAC": "Left Angle Cross of Masks 2"},
    8: {"RAC": "Right Angle Cross of Contagion 2", "JXP": "Juxtaposition Cross of Contribution", "LAC": "Left Angle Cross of Uncertainty 2"},
    9: {"RAC": "Right Angle Cross of Planning 2", "JXP": "Juxtaposition Cross of Focus", "LAC": "Left Angle Cross of Dedication 2"},
    10: {"RAC": "Right Angle Cross of the Vessel of Love 2", "JXP": "Juxtaposition Cross of Behavior", "LAC": "Left Angle Cross of Prevention 2"},
    11: {"RAC": "Right Angle Cross of Eden 2", "JXP": "Juxtaposition Cross of Ideas", "LAC": "Left Angle Cross of Education 2"},
    12: {"RAC": "Right Angle Cross of Eden 3", "JXP": "Juxtaposition Cross of Articulation", "LAC": "Left Angle Cross of Education 1"},
    13: {"RAC": "Right Angle Cross of the Sphinx 1", "JXP": "Juxtaposition Cross of Listening", "LAC": "Left Angle Cross of Masks 1"},
    14: {"RAC": "Right Angle Cross of the Vessel of Love 4", "JXP": "Juxtaposition Cross of Power Skills", "LAC": "Left Angle Cross of Uncertainty 1"},
    15: {"RAC": "Right Angle Cross of the Vessel of Love 1", "JXP": "Juxtaposition Cross of Extremes", "LAC": "Left Angle Cross of Prevention 1"},
    16: {"RAC": "Right Angle Cross of Planning 3", "JXP": "Juxtaposition Cross of Experimentation", "LAC": "Left Angle Cross of Identification 1"},
    17: {"RAC": "Right Angle Cross of Service 1", "JXP": "Juxtaposition Cross of Opinions", "LAC": "Left Angle Cross of Upheaval 1"},
    18: {"RAC": "Right Angle Cross of Service 2", "JXP": "Juxtaposition Cross of Correction", "LAC": "Left Angle Cross of Upheaval 2"},
    19: {"RAC": "Right Angle Cross of the Four Ways 1", "JXP": "Juxtaposition Cross of Need", "LAC": "Left Angle Cross of Refinement 1"},
    20: {"RAC": "Right Angle Cross of the Sleeping Phoenix 1", "JXP": "Juxtaposition Cross of the Now", "LAC": "Left Angle Cross of Duality 1"},
    21: {"RAC": "Right Angle Cross of Tension 1", "JXP": "Juxtaposition Cross of Control", "LAC": "Left Angle Cross of Endeavor 1"},
    22: {"RAC": "Right Angle Cross of Rulership 1", "JXP": "Juxtaposition Cross of Grace", "LAC": "Left Angle Cross of Informing 1"},
    23: {"RAC": "Right Angle Cross of Explanation 1", "JXP": "Juxtaposition Cross of Assimilation", "LAC": "Left Angle Cross of Dedication 1"},
    24: {"RAC": "Right Angle Cross of the Four Ways 4", "JXP": "Juxtaposition Cross of Rationalization", "LAC": "Left Angle Cross of Incarnation 2"},
    25: {"RAC": "Right Angle Cross of the Vessel of Love 3", "JXP": "Juxtaposition Cross of Innocence", "LAC": "Left Angle Cross of the Spirit 1"},
    26: {"RAC": "Right Angle Cross of Rulership 2", "JXP": "Juxtaposition Cross of the Trickster", "LAC": "Left Angle Cross of Confrontation 2"},
    27: {"RAC": "Right Angle Cross of the Unexpected 1", "JXP": "Juxtaposition Cross of Caring", "LAC": "Left Angle Cross of Alignment 1"},
    28: {"RAC": "Right Angle Cross of the Unexpected 2", "JXP": "Juxtaposition Cross of Risks", "LAC": "Left Angle Cross of Alignment 2"},
    29: {"RAC": "Right Angle Cross of Contagion 4", "JXP": "Juxtaposition Cross of Commitment", "LAC": "Left Angle Cross of Industry 2"},
    30: {"RAC": "Right Angle Cross of Contagion 1", "JXP": "Juxtaposition Cross of Fates", "LAC": "Left Angle Cross of Industry 1"},
    31: {"RAC": "Right Angle Cross of the Unexpected 3", "JXP": "Juxtaposition Cross of Influence", "LAC": "Left Angle Cross of the Alpha 1"},
    32: {"RAC": "Right Angle Cross of Maya 4", "JXP": "Juxtaposition Cross of Continuity", "LAC": "Left Angle Cross of Limitation 2"},
    33: {"RAC": "Right Angle Cross of the Four Ways 2", "JXP": "Juxtaposition Cross of Retreat", "LAC": "Left Angle Cross of Refinement 2"},
    34: {"RAC": "Right Angle Cross of the Sleeping Phoenix 2", "JXP": "Juxtaposition Cross of Power", "LAC": "Left Angle Cross of Duality 2"},
    35: {"RAC": "Right Angle Cross of Consciousness 2", "JXP": "Juxtaposition Cross of Experience", "LAC": "Left Angle Cross of Separation 2"},
    36: {"RAC": "Right Angle Cross of Eden 4", "JXP": "Juxtaposition Cross of Crisis", "LAC": "Left Angle Cross of the Plane 2"},
    37: {"RAC": "Right Angle Cross of Planning 1", "JXP": "Juxtaposition Cross of Bargains", "LAC": "Left Angle Cross of Migration 1"},
    38: {"RAC": "Right Angle Cross of Tension 2", "JXP": "Juxtaposition Cross of Opposition", "LAC": "Left Angle Cross of Individualism 2"},
    39: {"RAC": "Right Angle Cross of Tension 3", "JXP": "Juxtaposition Cross of Provocation", "LAC": "Left Angle Cross of Individualism 1"},
    40: {"RAC": "Right Angle Cross of Planning 4", "JXP": "Juxtaposition Cross of Denial", "LAC": "Left Angle Cross of Migration 2"},
    41: {"RAC": "Right Angle Cross of the Unexpected 4", "JXP": "Juxtaposition Cross of Fantasy", "LAC": "Left Angle Cross of the Alpha 2"},
    42: {"RAC": "Right Angle Cross of Maya 1", "JXP": "Juxtaposition Cross of Completion", "LAC": "Left Angle Cross of Limitation 1"},
    43: {"RAC": "Right Angle Cross of Explanation 4", "JXP": "Juxtaposition Cross of Insight", "LAC": "Left Angle Cross of Dedication 2"},
    44: {"RAC": "Right Angle Cross of the Four Ways 3", "JXP": "Juxtaposition Cross of Alertness", "LAC": "Left Angle Cross of Incarnation 1"},
    45: {"RAC": "Right Angle Cross of Rulership 3", "JXP": "Juxtaposition Cross of Possession", "LAC": "Left Angle Cross of Confrontation 1"},
    46: {"RAC": "Right Angle Cross of the Vessel of Love", "JXP": "Juxtaposition Cross of Serendipity", "LAC": "Left Angle Cross of Healing 2"},
    47: {"RAC": "Right Angle Cross of Rulership 4", "JXP": "Juxtaposition Cross of Oppression", "LAC": "Left Angle Cross of Informing 2"},
    48: {"RAC": "Right Angle Cross of Tension 4", "JXP": "Juxtaposition Cross of Depth", "LAC": "Left Angle Cross of Endeavor 2"},
    49: {"RAC": "Right Angle Cross of Explanation 3", "JXP": "Juxtaposition Cross of Principles", "LAC": "Left Angle Cross of Revolution 1"},
    50: {"RAC": "Right Angle Cross of Laws 2", "JXP": "Juxtaposition Cross of Values", "LAC": "Left Angle Cross of Wishes 2"},
    51: {"RAC": "Right Angle Cross of Penetration 1", "JXP": "Juxtaposition Cross of Shock", "LAC": "Left Angle Cross of the Clarion 1"},
    52: {"RAC": "Right Angle Cross of Service 3", "JXP": "Juxtaposition Cross of Stillness", "LAC": "Left Angle Cross of Demands 1"},
    53: {"RAC": "Right Angle Cross of Penetration 2", "JXP": "Juxtaposition Cross of Beginnings", "LAC": "Left Angle Cross of Cycles 2"},
    54: {"RAC": "Right Angle Cross of Penetration 3", "JXP": "Juxtaposition Cross of Ambition", "LAC": "Left Angle Cross of Cycles 1"},
    55: {"RAC": "Right Angle Cross of the Sleeping Phoenix 3", "JXP": "Juxtaposition Cross of Moods", "LAC": "Left Angle Cross of Spirit 2"},
    56: {"RAC": "Right Angle Cross of Laws 3", "JXP": "Juxtaposition Cross of Stimulation", "LAC": "Left Angle Cross of Distraction 1"},
    57: {"RAC": "Right Angle Cross of Penetration 4", "JXP": "Juxtaposition Cross of Intuition", "LAC": "Left Angle Cross of the Clarion 2"},
    58: {"RAC": "Right Angle Cross of Service 4", "JXP": "Juxtaposition Cross of Vitality", "LAC": "Left Angle Cross of Demands 2"},
    59: {"RAC": "Right Angle Cross of the Sleeping Phoenix 4", "JXP": "Juxtaposition Cross of Strategy", "LAC": "Left Angle Cross of the Spirit 1"},
    60: {"RAC": "Right Angle Cross of Laws 4", "JXP": "Juxtaposition Cross of Limitation", "LAC": "Left Angle Cross of Distraction 2"},
    61: {"RAC": "Right Angle Cross of Maya 2", "JXP": "Juxtaposition Cross of Thinking", "LAC": "Left Angle Cross of Obscuration 2"},
    62: {"RAC": "Right Angle Cross of Maya 3", "JXP": "Juxtaposition Cross of Detail", "LAC": "Left Angle Cross of Obscuration 1"},
    63: {"RAC": "Right Angle Cross of Consciousness 3", "JXP": "Juxtaposition Cross of Doubts", "LAC": "Left Angle Cross of Dominion 1"},
    64: {"RAC": "Right Angle Cross of Consciousness 4", "JXP": "Juxtaposition Cross of Confusion", "LAC": "Left Angle Cross of Dominion 2"},
}
    ...
    for gate, data in GATE_DATABASE.items():
        ...
        if partner_gate in GATE_DATABASE:
            ...
            if partner_data.gk_programming_partner != gate:
                errors.append(f"Asymmetric programming partners: {gate} -> {partner_gate} -> {partner_data.gk_programming_partner}")
...
if __name__ == "__main__":
    ...
    print(f"  Sun Line:  {daily.sun_activation.line} ({daily.sun_activation.line_archetype.name if daily.sun_activation.line_archetype else 'Unknown'})")
