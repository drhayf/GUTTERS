"""
╔══════════════════════════════════════════════════════════════════════════════╗
║                    COUNCIL JOURNAL GENERATOR                                 ║
║                                                                              ║
║   Automatically generates high-fidelity journal entries for cosmic events.  ║
║   Synthesizes I-Ching, Cardology, and Council data into reflective content. ║
║                                                                              ║
...
class CouncilJournalGenerator:
    ...
    def generate_gate_transition_entry(
        ...
        title = f"🌀 Gate Shift: Entering {gate_name}"
        ...
        content = f"""## Cosmic Transit: {old_name} → {gate_name}

The Sun has moved from **Gate {transition.old_sun_gate}** ({old_name}) into **Gate {transition.new_sun_gate}** ({gate_name}).

### Gene Key Frequency Spectrum

- **Shadow**: {new_shadow} — The unconscious pattern to observe
- **Gift**: {new_gift} — The frequency to cultivate
- **Siddhi**: {new_siddhi} — The highest expression
...
The transition from {old_gift} to {new_gift} marks a shift in the collective and personal field. This is an invitation to:
...
"""
    ...
    def generate_daily_synthesis_entry(
        ...
        """
        # Title
        title = f"☀️ Daily Code: Gate {hexagram.sun_gate}.{hexagram.sun_line} — {hexagram.sun_gene_key_gift}"
        ...
        resonance_emoji = {
            ...
            "challenging": "🔥",
            "dissonant": "🌊",
        }.get(synthesis.resonance_type, "⭐")
        
        content = f"""## Council of Systems Daily Synthesis

### I-Ching Hexagram (Micro-Cycle)

**Sun Position**: Gate {hexagram.sun_gate}.{hexagram.sun_line} — {hexagram.sun_gate_name}
**Earth Position**: Gate {hexagram.earth_gate}.{hexagram.earth_line} — {hexagram.earth_gate_name}
...
"""
    ...
    def generate_resonance_shift_entry(
        ...
        title = f"⚡ Resonance Shift: {old_resonance.title()} {direction} {new_resonance.title()}"
...
*Resonance shifts mark significant moments in the cosmic weather. Use this awareness to navigate your day with intention.*
"""
    ...
    def _get_resonance_direction(self, old: str, new: str) -> str:
        ...
        try:
            ...
            return "→" if new_idx > old_idx else "←"
        except ValueError:
            return "→"
    ...
    def _get_resonance_meaning(self, old: str, new: str) -> str:
        ...
        meanings = {
            ("challenging", "harmonic"): "A significant shift from tension to flow. The systems that were in opposition are now working together.",
            ("harmonic", "challenging"): "Moving into a period of productive tension. This is not negative—it's an invitation for deeper integration.",
            ("neutral", "harmonic"): "The neutral potential has crystallized into alignment. A favorable time for aligned action.",
            ("neutral", "challenging"): "The open field has developed friction. Use this energy for transformation.",
        }
        return meanings.get((old, new), f"The shift from {old} to {new} marks a new chapter in the cosmic narrative.")
