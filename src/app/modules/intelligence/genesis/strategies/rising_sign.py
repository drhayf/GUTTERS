...
{hypothesis.suspected_value} rising typically comes across as:
{self.IMPRESSIONS.get(hypothesis.suspected_value, "unique")}
...
{{
    "question": (
        "Think of a few major turning points in your life - starting a career, "
        "big relationship changes, moving. Do you notice any patterns in when "
        "these tend to happen?"
    ),
    "analysis_hints": {{
...
{{
    "question": (
        "Some people have mentioned you have [trait description]. Does that "
        "resonate with how you or others see you?"
    ),
    "mappings": {{
