...
def _pattern_relates_to_hypothesis(pattern: Dict[str, Any], hypothesis) -> bool:
    ...
    """
    from src.app.modules.intelligence.hypothesis.models import HypothesisType, HypothesisStatus
...
async def get_cyclical_patterns(
    ...
    """
    from src.app.modules.intelligence.observer.cyclical import (
...
async def get_cyclical_summary(
    ...
    if mood_patterns:
        ...
        summary["best_period"] = {
            "planet": best_pattern.planet_high.value if hasattr(best_pattern.planet_high, 'value') and best_pattern.planet_high else None,
            "avg_mood": best_pattern.high_value
        }
        summary["challenging_period"] = {
            "planet": best_pattern.planet_low.value if hasattr(best_pattern.planet_low, 'value') and best_pattern.planet_low else None,
