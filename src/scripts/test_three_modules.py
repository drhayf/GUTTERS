...
from app.modules.calculation.human_design.brain.interpreter import HumanDesignInterpreter
...
def generate_synthesis_summary(name: str, astro_chart: dict, hd_chart, num_chart, 
    ...
    print(f"   Accuracy: full (doesn't require birth time)")
...
def main():
    ...
    try:
        ...
        print(f"  • Numerology: full (always)")
