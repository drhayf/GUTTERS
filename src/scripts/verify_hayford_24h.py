...
print(f"Our calculation at 12:00 shows: {calc._calculate_full_chart(name='H', birth_date=date(1999,7,23), birth_time=time(12,0), latitude=5.6037, longitude=-0.1870, timezone='Africa/Accra').type}")
