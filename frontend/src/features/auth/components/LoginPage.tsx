            ...
            >
                <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <h1 className="text-2xl font-bold tracking-tight text-foreground/90">Welcome to GUTTERS</h1>
                        <p className="text-sm text-muted-foreground font-medium">This is how you get out.</p>
                    </div>
                </div>
